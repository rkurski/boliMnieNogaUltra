...
if (typeof GAME === 'undefined') { } else {
    ...
    let Pgg = setInterval(() => {
        ...
        class kwsv3 {
            constructor(charactersManager, connectionManager) {
            ...
            loadRiddles(cb) {
                fetch(`https://raw.githubusercontent.com/rkurski/boliMnieNogaUltra/main/riddles.json`).then(res => res.json()).then((out) => {
                    cb(out)
                }).catch(err => {
                    throw err
                });
            ...
            bindClickHandlers() {
                ...
                $("body").on("click", ".qlink.load_afo", () => {
                    if (typeof this.afo_is_loaded == 'undefined') {
                        ...
                        $.get("https://raw.githubusercontent.com/rkurski/boliMnieNogaUltra/main/uncodedeeee.js", (data) => {
